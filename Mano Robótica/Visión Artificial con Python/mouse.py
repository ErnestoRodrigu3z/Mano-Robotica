...
def detect_finger_down(hand_landmarks):
    ...
    x_base2 = int(hand_landmarks.landmark[5].x * width)
    y_base2 = int(hand_landmarks.landmark[5].y * height)
    ...
    d_base_index = calculate_distance(x_base2, y_base2, x_index, y_index)
    print (d_base_index)
